...
**Bottom line.** Book the slot. Get the B. Even when the wait tests your patience, that B is the only reason your name moves before the R crowd. The booking will not spare you the wait, but it will spare you the uncertainty, and by the end of the morning it is what gets you out the door first.